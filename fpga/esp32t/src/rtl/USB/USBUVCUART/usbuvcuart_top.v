...
module usbuvcuart_top(
    ...
    input [7:0]         PC_STREAM_DATA,
    input               PC_STREAM_VALID,
    output              PC_STREAM_READY,
    ...
    */
    ...
    wire        ep3_tx_ready;
    wire [7:0]  ep3_tx_source_data;
    wire        ep3_tx_source_valid;
    ...
    usb_cdc_tx_mux u_usb_cdc_tx_mux (
        .reset(usb_busreset | RESET_IN),
        .pclk(pClk),
        .gclk(hClk),
        .uart_data_p(uart_rx_data[7:0]),
        .uart_valid_p(uart_rx_data_val),
        .stream_data_g(PC_STREAM_DATA),
        .stream_valid_g(PC_STREAM_VALID),
        .stream_ready_g(PC_STREAM_READY),
        .endpoint_ready_g(ep3_tx_ready),
        .endpoint_data_g(ep3_tx_source_data),
        .endpoint_valid_g(ep3_tx_source_valid)
    );
    ...
    (
        ...
        ,.i_ep3_tx_dval (ep3_tx_source_valid)
        ,.i_ep3_tx_data (ep3_tx_source_data)
        ,.o_ep3_tx_rdy  (ep3_tx_ready     )
        ,.i_ep3_rx_clk  (pClk             )
