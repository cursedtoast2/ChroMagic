...
add_file -type verilog "src/rtl/BSP/cart_bus_owner_mux.sv"
add_file -type verilog "src/rtl/BSP/cart_maintenance_cdc.sv"
add_file -type verilog "src/rtl/BSP/cart_maintenance_engine.sv"
add_file -type verilog "src/rtl/BSP/cart_usb_streamer.sv"
add_file -type verilog "src/rtl/BSP/virtual_cart_session_cdc.sv"
add_file -type verilog "src/rtl/BSP/virtual_cart_rtc_cdc.sv"
...
add_file -type verilog "src/rtl/BSP/maintenance_video_mux.sv"
add_file -type verilog "src/rtl/BSP/maintenance_video_source.sv"
...
add_file -type verilog "src/rtl/BSP/usb_cdc_tx_mux.sv"
...
add_file -type verilog "src/rtl/EMU/audio_filter_deterministic.sv"
...
add_file -type verilog "src/rtl/EMU/virtual_cart_cache.sv"
add_file -type verilog "src/rtl/EMU/virtual_cart_mapper.sv"
add_file -type verilog "src/rtl/EMU/virtual_cart_runtime.sv"
add_file -type verilog "src/Gameboy_MiSTer/rtl/mappers/mbc1.v"
add_file -type verilog "src/Gameboy_MiSTer/rtl/mappers/mbc2.v"
add_file -type verilog "src/Gameboy_MiSTer/rtl/mappers/mbc3.v"
add_file -type verilog "src/Gameboy_MiSTer/rtl/mappers/mbc5.v"
add_file -type verilog "src/Gameboy_MiSTer/rtl/mappers/huc1.v"
